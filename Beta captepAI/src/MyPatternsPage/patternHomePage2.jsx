...
export const PatternHomePage = () => {
   ...
   const [data2] = [
    { id:1 ,logo:<WebhookIcon/> ,card:'standard',BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)'  ,title:'Software Proposal Writer ',Descrioption:'The Project Proposal Writer is an intelligent solution designed to help users effortlessly generate comprehensive, professional-quality project proposals tailored to their needs.',
        sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ] ,
        ButtonSection:[
            { buttonLabe:'Project Name',
              buttonTemplete:[
                {
                    input:"text",
                ...
                },
                {
                    ...
                    description:'Describe the primary goals or aims of this project.'
                },
                {
                    input:"text",
                    placeholder:'Expected Outcome',
                    description:'Explain the results or benefits expected from this project.'

                }
              ]  
            },
            { buttonLabe:'Company Information',
                buttonTemplete:[
                  {
                      input:"text",
                      placeholder:'Company Name',
                      description:'Provide the name of the company involved in the project.'
                  },
                  {
                      input:"text",
                      placeholder:'Website',
                      description:'Enter the official website URL of the company.'
                  },
                  {
                      input:"text",
                      placeholder:'Industry/Domain',
                      description:'Specify the industry or domain this project belongs to..'
  
                  }
                ]  
              },
              { buttonLabe:'Technology Stack',
                buttonTemplete:[
                  {
                      input:"textArea",
                      placeholder:'Type something about Key Stakholders',
                      description:'List the individuals or groups who have a significant interest in the project.'
                  }
                ]  
              },
              { buttonLabe:'Timeline',
                buttonTemplete:[
                  {
                      ...
                      description:'Enter the planned starting date for the project.'
                  },
                  {
                    input:"text",
                    placeholder:'End Date',
                    description:'Enter the planned completion date for the project.'
                  },
                  {
                    input:"text",
                    placeholder:'Milestones',
                    description:'Define the key phases or milestones of the project timeline.'
                  },
                  {
                    input:"text",
                    placeholder:'Deadlines',
                    description:'Specify any critical deadlines associated with the project milestones..'
                  }
                ]  
              },
              { buttonLabe:'Budget',
                buttonTemplete:[
                  {
                      input:"textArea",
                      placeholder:'Type something about Resource Costs',
                      description:'Detail the estimated costs for resources such as personnel or materials.'
                  },
                  {
                    input:"textArea",
                    placeholder:'Expenses Breakdown',
                    description:'Provide a breakdown of all projected expenses for the project..'
                  }
                ]  
              }
        ]
   ...
   const [data] = useState([
    { id:1 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ] ,logo:<WebhookIcon/> ,card:'standard',BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)'  ,title:'Software Proposal Writer ',Descrioption:'The Project Proposal Writer is an intelligent solution designed to help users effortlessly generate comprehensive, professional-quality project proposals tailored to their needs.' },
    { id:2 ,sectionButton:['Ad Content'],logo:<LinkedInIcon/> ,card:'standard' ,BackgroundColor:'linear-gradient(200deg, #ae0503 40%, #f39492 100%)' ,title:'LinkedIn Ad Writer' ,Descrioption:'An expertly crafted framework to design impactful LinkedIn Ad content that captures attention and drives engagement.'},
    { id:3 ,sectionButton:['Campaign Overview' ],logo:<FacebookIcon/> ,card:'standard' ,BackgroundColor:'linear-gradient( 200deg, #a706f4 40%,  #eab0f5 100%)' ,title:'Facebook Ad Writer' ,Descrioption:'An intuitive framework designed to create compelling Facebook Post content by incorporating key elements such as an engaging headline, a clear call-to-action, and attention-grabbing visuals.'},
    { id:4 ,sectionButton:['Post Details','company Information','Technology Stack','Timeline','Budget' ],logo:<LinkedInIcon/> ,card:'standard',BackgroundColor:'linear-gradient( 200deg, #119439 40%,rgb(156, 216, 146) 100%)',title:'LinkedIn Post Writer' ,Descrioption:'An expertly crafted framework to design impactful LinkedIn Post content that captures attention and drives engagement.'},
    { id:5 ,sectionButton:['Post Details','company Information','Technology Stack','Timeline','Budget' ],logo:<FacebookIcon/> ,card:'standard', BackgroundColor:'linear-gradient(200deg, #2806A6 40%, #8664e4 100%)',title:'Facebook Post Writer' ,Descrioption:'An intuitive framework designed to create compelling Facebook Ad content by incorporating key elements such as an engaging headline, a clear call-to-action, and attention-grabbing visuals.'},
    { id:6 ,sectionButton:['Email Generation'],logo:<EmailIcon/> ,card:'standard', BackgroundColor:'linear-gradient(200deg, #186E6F 40%,rgb(66, 157, 128) 100%)' ,title:'Email  Writer' ,Descrioption:'A smart framework for crafting effective email content that captures attention and drives action.'},
   
    { id:7 ,sectionButton:['Details','Core Settings','Media Hub','Connect to Web','Syndication'],logo:<PostAddIcon/> ,card:'standard',BackgroundColor:'linear-gradient( 200deg, #119439 40%,rgb(156, 216, 146) 100%)'  ,title:'Blog Post Writer' ,Descrioption:'An SEO Writer specializes in creating content that is optimized for both search engines and users'},
    { id:8 ,sectionButton:['Transcript'],logo:<GroupsIcon/> ,card:'standard' ,BackgroundColor:'linear-gradient(200deg, #2806A6 40%, #8664e4 100%)' ,title:'Minutes of Meeting(MOM) Writer Ad Writer' ,Descrioption:'This pattern transforms meeting transcripts into well-organized Minutes of Meeting (MoM), capturing key discussions, decisions, and actionable tasks.'},
    { id:9 ,sectionButton:['Transcript'],logo:<EventRepeatIcon/> ,card:'standard' , BackgroundColor:'linear-gradient(200deg, #186E6F 40%,rgb(66, 157, 128) 100%)',title:'Daily Scrum Report Writer' ,Descrioption:'Scrum report pattern is designed to transform raw meeting transcripts into a structured and actionable Scrum report. It systematically organizes the transcript data to provide clear insights into the team’s progress and challenges. By breaking down individual contributions in the Sprint Progress section, the prompt ensures accountability and transparency for each team member.'},
    { id:10 ,sectionButton:['Transcript'],logo:<MeetingRoomIcon/> ,card:'standard', BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)' ,title:'Sprint Retrospect Meeting Summary' ,Descrioption:'This pattern converts a Sprint Retrospective meeting transcript into a clear, actionable summary, helping Agile teams reflect on their sprint performance.'},
    { id:11 ,sectionButton:['High Level Requirements'],logo:<AutoStoriesIcon/> , card:'standard', BackgroundColor:'linear-gradient(200deg, #ae0503 40%, #f39492 100%)' , title:'Agile User Story Writer' ,Descrioption:'Generate Agile user stories based on discussion points or transcripts, including clear goals, acceptance criteria for defining "done," and dependencies for successful implementation.'},
    { id:12 ,sectionButton:['Job Role Details'],logo:<WorkIcon/> , card:'standard' ,BackgroundColor:'linear-gradient( 200deg, #a706f4 40%,  #eab0f5 100%)'  , title:'Job Description Writer' ,Descrioption:'This Job Description Writer enables users to input key details and generate a comprehensive, tailored job description. It ensures all necessary elements are included, making the process quick and effective for attracting the right candidates.'},
   
    { id:13 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)'  ,title:'Custom Pattern 1' ,Descrioption:'An SEO Writer specializes in creating content that is optimized for both search engines and users'},
    { id:14 ,sectionButton:['project Details 1','company Information 2','Technology Stack3','Timeline4','Budget3' ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient(200deg, #ae0503 40%, #f39492 100%)' ,title:'Custom Pattern 2' ,Descrioption:'This pattern transforms meeting transcripts into well-organized Minutes of Meeting (MoM), capturing key discussions, decisions, and actionable tasks.'},
    { id:15 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient( 200deg, #a706f4 40%,  #eab0f5 100%)' ,title:'Custom Pattern 3' ,Descrioption:'Scrum report pattern is designed to transform raw meeting transcripts into a structured and actionable Scrum report. It systematically organizes the transcript data to provide clear insights into the team’s progress and challenges. By breaking down individual contributions in the Sprint Progress section, the prompt ensures accountability and transparency for each team member.'},
    { id:16 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom' ,BackgroundColor:'linear-gradient( 200deg, #119439 40%,rgb(156, 216, 146) 100%)' ,title:'Custom Pattern 4' ,Descrioption:'This pattern converts a Sprint Retrospective meeting transcript into a clear, actionable summary, helping Agile teams reflect on their sprint performance.'},
    { id:1 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)'  ,title:'Custom Pattern 5 ',Descrioption:'The Project Proposal Writer is an intelligent solution designed to help users effortlessly generate comprehensive, professional-quality project proposals tailored to their needs.' },
    { id:2 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom' ,BackgroundColor:'linear-gradient(200deg, #ae0503 40%, #f39492 100%)' ,title:'Custom Pattern 6' ,Descrioption:'An expertly crafted framework to design impactful LinkedIn Ad content that captures attention and drives engagement.'},
    { id:3 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom' ,BackgroundColor:'linear-gradient( 200deg, #a706f4 40%,  #eab0f5 100%)' ,title:'Custom Pattern 7' ,Descrioption:'An intuitive framework designed to create compelling Facebook Post content by incorporating key elements such as an engaging headline, a clear call-to-action, and attention-grabbing visuals.'},
    { id:4 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient( 200deg, #119439 40%,rgb(156, 216, 146) 100%)',title:'Custom Pattern 8' ,Descrioption:'An expertly crafted framework to design impactful LinkedIn Post content that captures attention and drives engagement.'},
    { id:5 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom', BackgroundColor:'linear-gradient(200deg, #2806A6 40%, #8664e4 100%)',title:'Custom Pattern 9' ,Descrioption:'An intuitive framework designed to create compelling Facebook Ad content by incorporating key elements such as an engaging headline, a clear call-to-action, and attention-grabbing visuals.'},
    { id:6 ,sectionButton:['project Details','company Information','Technology Stack','Timeline','Budget' ],logo:<Crown/> ,card:'Custom', BackgroundColor:'linear-gradient(200deg, #186E6F 40%,rgb(66, 157, 128) 100%)' ,title:'Custom Pattern 10' ,Descrioption:'A smart framework for crafting effective email content that captures attention and drives action.'},
   
    { id:7 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> ,card:'Custom',BackgroundColor:'linear-gradient( 200deg, #119439 40%,rgb(156, 216, 146) 100%)'  ,title:'Custom Pattern 11' ,Descrioption:'An SEO Writer specializes in creating content that is optimized for both search engines and users'},
    { id:8 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> ,card:'Custom' ,BackgroundColor:'linear-gradient(200deg, #2806A6 40%, #8664e4 100%)' ,title:'Custom Pattern 12' ,Descrioption:'This pattern transforms meeting transcripts into well-organized Minutes of Meeting (MoM), capturing key discussions, decisions, and actionable tasks.'},
    { id:9 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> ,card:'Custom' , BackgroundColor:'linear-gradient(200deg, #186E6F 40%,rgb(66, 157, 128) 100%)',title:'Custom Pattern 13' ,Descrioption:'Scrum report pattern is designed to transform raw meeting transcripts into a structured and actionable Scrum report. It systematically organizes the transcript data to provide clear insights into the team’s progress and challenges. By breaking down individual contributions in the Sprint Progress section, the prompt ensures accountability and transparency for each team member.'},
    { id:10 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> ,card:'Custom', BackgroundColor:'linear-gradient(200deg, #057F8C 40%,  #1AC8DA 100%)' ,title:'Custom Pattern 14' ,Descrioption:'This pattern converts a Sprint Retrospective meeting transcript into a clear, actionable summary, helping Agile teams reflect on their sprint performance.'},
    { id:11 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> , card:'Custom', BackgroundColor:'linear-gradient(200deg, #ae0503 40%, #f39492 100%)' , title:'Custom Pattern 15' ,Descrioption:'Generate Agile user stories based on discussion points or transcripts, including clear goals, acceptance criteria for defining "done," and dependencies for successful implementation.'},
    { id:12 ,sectionButton:["project Details","company Information","Technology Stack","Timeline","Budget" ],logo:<Crown/> , card:'Custom' ,BackgroundColor:'linear-gradient( 200deg, #a706f4 40%,  #eab0f5 100%)'  , title:'Custom Pattern 16' ,Descrioption:'This Job Description Writer enables users to input key details and generate a comprehensive, tailored job description. It ensures all necessary elements are included, making the process quick and effective for attracting the right candidates.'},
...
const [animationClass, setAnimationClass] = useState("");
    ...
    const [ currenindexcards ,setCurrentIndexcards] = useState(null);

    const handleClickOpen = ( firstIndex ) => {
        setCurrentIndexcards(firstIndex);
        setOpen(true);
    };
  
    const handleClose = () => {
        setCurrentIndexcards(null);
        setOpen(false);
    };
//    -------------------------------------------
                                    ...
                                    <div  style={{ width:'100%', display:'flex', justifyContent:'start',alignItems:'center'}} >    
                                        ...
                                        <Dialog  style={{background:' #F9FAFB'}} open={open}  onClose={handleClose} maxWidth="lg"  >
                                           <div style={{padding:'15px'}}>
                                                ...
                                                {currenindexcards && (
                                                   <ClickPatternCards patternName={currenindexcards}  />
                                                )}    
                                           </div>  
                                        </Dialog>
                                        </div>         
                                ...
                                <div style={{ width:'100%',display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center',padding:'20px 25px', backgroundColor:'white', borderRadius:'20px'}}>
                                    ...
                                    <div  style={{ width:'100%', display:'flex', justifyContent:'start',alignItems:'center'}} >    
                                        ...
                                        {filterCards.filter((item) =>item.card ==='standard') .map((item) => (
                                            <Cards  handleClickOpen={() => handleClickOpen(item)}
                                            key={item.id}
                                            Logo={ item.logo ? React.cloneElement(item.logo,{style:{  ...logoDefaultStyle, ...item.style}}): null } 
                                            SpanTitle={item.title}
                                            SpanParagraph={item.Descrioption}
